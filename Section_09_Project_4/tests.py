...
class TestIntegerField(unittest.TestCase):
    class Person:
        age = solution.IntegerField(0, 10)
...
class TestIntegerField(unittest.TestCase):
    ...
    def test_set_age_ok(self):
        min_ = 5
        max_ = 10
        self.Person.age = solution.IntegerField(5, 10)
        p = self.Person()
        p.age = 5
...
class TestIntegerField(unittest.TestCase):
    ...
    def create_person(self, min_, max_):
        self.Person.age = solution.IntegerField(min_, max_)
...
class TestIntegerField(unittest.TestCase):
    ...
    def create_test_class(min_, max_):
        obj = type('TestClass', (), {'age': solution.IntegerField(min_, max_)})
        return obj
...
class TestIntegerField(unittest.TestCase):
    ...
    def test_class_get(self):
        ...
        obj_class = type(obj)
        self.assertIsInstance(obj_class.age, solution.IntegerField)
...
class TestCharField(unittest.TestCase):
    @staticmethod
    def create_test_class(min_, max_):
        obj = type('TestClass', (), {'name': solution.CharField(min_, max_)})
        return obj()
    ...
    def test_class_get(self):
        ...
        obj = self.create_test_class(0, 0)
        obj_class = type(obj)
        self.assertIsInstance(obj_class.name, solution.CharField)
