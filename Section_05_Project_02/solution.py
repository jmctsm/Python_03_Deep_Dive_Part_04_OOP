...
class Mod:
    ...
    def __eq__(self, other):
        # calculates congruence (same equivalent class)
        other_value = self._get_value(other)
    ...
    def __add__(self, other):
        return self._perform_operations(other, operator.add)

    def __iadd__(self, other):
        return self._perform_operations(other, operator.add, in_place=True)

    def __sub__(self, other):
        return self._perform_operations(other, operator.sub)

    def __isub__(self, other):
        return self._perform_operations(other, operator.sub, in_place=True)

    def __mul__(self, other):
        return self._perform_operations(other, operator.mul)

    def __imul__(self, other):
        return self._perform_operations(other, operator.mul, in_place=True)

    def __pow__(self, other):
        return self._perform_operations(other, operator.pow)

    def __ipow__(self, other):
        return self._perform_operations(other, operator.pow, in_place=True)
